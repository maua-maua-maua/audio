...
from jukebox.transformer.ops import ACT_FNS, Conv1D, LayerNorm
...
if __name__ == "__main__":
    ...
    for attn_order in [0, 2, 6]:
        ...
        prior = Transformer(
            n_in, n_ctx, n_head, n_depth, mask=True, attn_order=attn_order, encoder_dims=encoder_dims, blocks=blocks
        ).cuda()
