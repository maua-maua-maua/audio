...
class ArtistGenreProcessor:
    ...
    def get_artist_id(self, artist):
        ...
        if artist not in self.artist_ids:
            print(
                f"Input artist {input_artist} maps to {artist}, which is not present in {self.artist_id_file}. "
    ...
    def get_genre_ids(self, genre):
        ...
        for word in genres:
            if word not in self.genre_ids:
                print(
                    f"Input genre {genre} maps to the list {genres}. {word} is not present in {self.genre_id_file}. "
