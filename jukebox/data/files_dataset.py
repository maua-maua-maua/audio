...
class FilesAudioDataset(Dataset):
    def __init__(self, hps):
        ...
        assert (
            hps.sample_length / hps.sr < self.min_duration
        ), f"Sample length {hps.sample_length} per sr {hps.sr} ({hps.sample_length / hps.sr:.2f}) should be shorter than min duration {self.min_duration}"
